"""
State preparation service for chat processing.
...
class StatePreparationService:
    """Service for preparing chat state and request data."""
    
    def __init__(self):
        self.logger = logging.getLogger(__name__)
    
    def prepare_request_data(self, request: ChatRequest) -> Dict[str, Any]:
    ...
    def prepare_graph_config(self, thread_id: str) -> Dict[str, Any]:
...
# Global instance
state_preparation_service = StatePreparationService()
